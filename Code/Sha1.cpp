...
std::vector<char> SHA1::final()
{
  ...
  //digets[..] contains the digest in 4 big-ending 32bit integers
  //byteswap those integers and treat them as char pointer to get the binary representation
  ...
  result2.resize(20);
  memcpy(&result2[0], digest, result2.size());
